...
module Sfx {
    ...
    (function () {
        ...
        angular.module("sfx", [
            ...
            "MeshAppServiceViewController",
            "MeshAppViewController",
            "MeshAppServiceReplicaViewController",
            "MeshGatewaysViewController",
            "MeshGatewayViewController",
            "MeshSecretsViewController",
            "MeshSecretViewController",
            "MeshVolumesViewController",
            "MeshVolumeViewController",
            "themeController",
            "settingsController",
